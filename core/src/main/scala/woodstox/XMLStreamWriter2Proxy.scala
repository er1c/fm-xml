...
trait XMLStreamWriter2Proxy extends XMLStreamWriter2 with XMLStreamWriterProxy {
  ...
  def copyEventFromReader(r: org.codehaus.stax2.XMLStreamReader2, preserveEventData: Boolean): Unit =
    self.copyEventFromReader(r, preserveEventData)
  ...
  def writeDTD(rootName: String, systemId: String, publicId: String, internalSubset: String): Unit =
    self.writeDTD(rootName, systemId, publicId, internalSubset)
  ...
  def writeStartDocument(version: String, encoding: String, standAlone: Boolean): Unit =
    self.writeStartDocument(version, encoding, standAlone)

  // Members declared in org.codehaus.stax2.validation.Validatable
  def setValidationProblemHandler(
    h: org.codehaus.stax2.validation.ValidationProblemHandler): org.codehaus.stax2.validation.ValidationProblemHandler =
    self.setValidationProblemHandler(h)
  def stopValidatingAgainst(
    validator: org.codehaus.stax2.validation.XMLValidator): org.codehaus.stax2.validation.XMLValidator =
    self.stopValidatingAgainst(validator)
  def stopValidatingAgainst(
    schema: org.codehaus.stax2.validation.XMLValidationSchema): org.codehaus.stax2.validation.XMLValidator =
    self.stopValidatingAgainst(schema)
  def validateAgainst(
    schema: org.codehaus.stax2.validation.XMLValidationSchema): org.codehaus.stax2.validation.XMLValidator =
    self.validateAgainst(schema)

  // Members declared in org.codehaus.stax2.typed.TypedXMLStreamWriter
  def writeBinary(variant: org.codehaus.stax2.typed.Base64Variant, value: Array[Byte], from: Int, length: Int): Unit =
    self.writeBinary(variant, value, from, length)
  def writeBinary(value: Array[Byte], from: Int, length: Int): Unit = self.writeBinary(value, from, length)
  def writeBinaryAttribute(
    variant: org.codehaus.stax2.typed.Base64Variant,
    prefix: String,
    namespaceURI: String,
    localName: String,
    value: Array[Byte]): Unit = self.writeBinaryAttribute(variant, prefix, namespaceURI, localName, value)
  def writeBinaryAttribute(prefix: String, namespaceURI: String, localName: String, value: Array[Byte]): Unit =
    self.writeBinaryAttribute(prefix, namespaceURI, localName, value)
  ...
  def writeBooleanAttribute(prefix: String, namespaceURI: String, localName: String, value: Boolean): Unit =
    self.writeBooleanAttribute(prefix, namespaceURI, localName, value)
  def writeDecimal(value: java.math.BigDecimal): Unit = self.writeDecimal(value)
  def writeDecimalAttribute(
    prefix: String,
    namespaceURI: String,
    localName: String,
    value: java.math.BigDecimal): Unit = self.writeDecimalAttribute(prefix, namespaceURI, localName, value)
  ...
  def writeDoubleArrayAttribute(prefix: String, namespaceURI: String, localName: String, value: Array[Double]): Unit =
    self.writeDoubleArrayAttribute(prefix, namespaceURI, localName, value)
  def writeDoubleAttribute(prefix: String, namespaceURI: String, localName: String, value: Double): Unit =
    self.writeDoubleAttribute(prefix, namespaceURI, localName, value)
  ...
  def writeFloatArrayAttribute(prefix: String, namespaceURI: String, localName: String, value: Array[Float]): Unit =
    self.writeFloatArrayAttribute(prefix, namespaceURI, localName, value)
  def writeFloatAttribute(prefix: String, namespaceURI: String, localName: String, value: Float): Unit =
    self.writeFloatAttribute(prefix, namespaceURI, localName, value)
  ...
  def writeIntArrayAttribute(prefix: String, namespaceURI: String, localName: String, value: Array[Int]): Unit =
    self.writeIntArrayAttribute(prefix, namespaceURI, localName, value)
  def writeIntAttribute(prefix: String, namespaceURI: String, localName: String, value: Int): Unit =
    self.writeIntAttribute(prefix, namespaceURI, localName, value)
  def writeInteger(value: java.math.BigInteger): Unit = self.writeInteger(value)
  def writeIntegerAttribute(
    prefix: String,
    namespaceURI: String,
    localName: String,
    value: java.math.BigInteger): Unit = self.writeIntegerAttribute(prefix, namespaceURI, localName, value)
  ...
  def writeLongArrayAttribute(prefix: String, namespaceURI: String, localName: String, value: Array[Long]): Unit =
    self.writeLongArrayAttribute(prefix, namespaceURI, localName, value)
  def writeLongAttribute(prefix: String, namespaceURI: String, localName: String, value: Long): Unit =
    self.writeLongAttribute(prefix, namespaceURI, localName, value)
  def writeQName(value: javax.xml.namespace.QName): Unit = self.writeQName(value)
  def writeQNameAttribute(
    prefix: String,
    namespaceURI: String,
    localName: String,
    value: javax.xml.namespace.QName): Unit = self.writeQNameAttribute(prefix, namespaceURI, localName, value)
