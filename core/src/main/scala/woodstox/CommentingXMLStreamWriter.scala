...
object CommentingXMLStreamWriter {
  ...
  private object StartElement {
    ...
    def apply(prefix: String, localName: String, namespaceURI: String): StartElement3 =
      StartElement3(prefix, localName, namespaceURI)
  }
  ...
  private object EmptyElement {
    ...
    def apply(prefix: String, localName: String, namespaceURI: String): EmptyElement3 =
      EmptyElement3(prefix, localName, namespaceURI)
  }

  private object Attribute {
    def apply(localName: String, value: String): Attribute2 = Attribute2(localName, value)
    def apply(namespaceURI: String, localName: String, value: String): Attribute3 =
      Attribute3(namespaceURI, localName, value)
    def apply(prefix: String, namespaceURI: String, localName: String, value: String): Attribute4 =
      Attribute4(prefix, namespaceURI, localName, value)
  }
  ...
  private case class Attribute4(prefix: String, namespaceURI: String, localName: String, value: String)
    extends Attribute {
...
final case class CommentingXMLStreamWriter(protected val self: IndentingXMLStreamWriter, comments: XMLCommentProvider)
