...
object XmlReaderFactory {
  ...
  def apply[T: ClassTag](
    ...
    new XmlReaderFactory(
      ...
      IndexedSeq(XmlReaderPath(itemName)))
  }
...
final class XmlReaderFactory[T] private (
  rootName: String,
  defaultNamespaceURI: String,
  overrideDefaultNamespaceURI: String,
  ...
  def reader(r: Resource[Reader]): XmlReader[T] =
    XmlReader(rootName, defaultNamespaceURI, overrideDefaultNamespaceURI, r, targets)
}
