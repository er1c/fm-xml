...
""".trim
  ...
  private val simplePartOneLineXmlWithDTD =
    """<?xml version='1.0' encoding='UTF-8'?><!DOCTYPE ACES SYSTEM "ACES.dtd"><feed><part><uniqueId>ONE</uniqueId><source>foo</source><name>Simple Part One</name></part><part><uniqueId>TWO</uniqueId><source>foo</source><name>Simple Part Two</name></part></feed>
                                            """.trim
  ...
  private val simplePartOneLineXmlWithDTDAndComments =
    """<?xml version='1.0' encoding='UTF-8'?><!-- foo --><!DOCTYPE ACES SYSTEM "ACES.dtd"><feed><part><uniqueId>ONE</uniqueId><source>foo</source><name>Simple Part One</name></part><part><uniqueId>TWO</uniqueId><source>foo</source><name>Simple Part Two</name></part></feed>
                                                       """.trim
